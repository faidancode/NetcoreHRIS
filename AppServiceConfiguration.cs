...
using NetcoreHRIS.Modules.Auth;
using NetcoreHRIS.Modules.Dashboard;
using NetcoreHRIS.Modules.Departments;
using NetcoreHRIS.Modules.Positions;
using NetcoreHRIS.Modules.Roles;
using NetcoreHRIS.Modules.Users;
using NetcoreHRIS.Modules.Employees;
...
public static class AppServiceConfiguration
{
    public static WebApplicationBuilder AddAppServices(this WebApplicationBuilder builder)
    {
        ...
        services.AddScoped<ILeaveMastersService, LeaveMastersService>();
